<?php // $Id: game.php,v 1.3.2.3 2010/07/31 07:50:12 bdaloukas Exp $
...
$string[ 'cross_nowords'] = 'Aucun mot trouvé';
...
$string[ 'hangman_nowords'] = 'Pas de mots';
$string[ 'hangman_win'] = 'Bravo !!';
...
$string[ 'attemptduration'] = 'Temps consommé';
...
//snakes/play.php
$string[ 'snakes_new'] = 'Nouveau jeu';
$string[ 'snakes_win'] = 'Bravo !!';
...
//sudoku/play.php
$string[ 'cross_new'] = 'Nouveau jeu';
$string[ 'sudoku_emptydatabase'] = 'La base de sudokus est vide. Lancez $a pour la créer';
