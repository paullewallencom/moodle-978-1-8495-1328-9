 ...
 * SimpleSpeak
 *
 * A Moodle filter to provide speech synthesis services for arbitrary text.
 *
 * Uses: jQuery, (Webanywhere)
 * @category  Moodle4-9
...
require_once($CFG->libdir.'/../filter/simplespeak/lib.php');
...
function simplespeak_filter($courseid, $text) {
    ...
    if (!is_string($text) || $filter_count > 2) { #0
