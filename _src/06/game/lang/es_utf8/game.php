<?php // $Id: game.php,v 1.7.2.5 2010/09/15 21:03:55 bdaloukas Exp $ 
...
$string[ 'game:manageoverrides'] = 'Gestionar reemplazos';
$string[ 'game:reviewmyattempts'] = 'Revisar mis intentos';
$string[ 'game:view'] = 'Ver';
$string[ 'game:viewreports'] = 'Ver reportes';
$string[ 'gameadministration'] = 'Administración del juego';
$string[ 'pluginadministration'] = 'Administración de la actividad del juego';
