...
$string[ 'bookquiz_numquestions'] = 'Питання';
...
$string[ 'cross_nowords'] = 'Не знайшлось жодного слова';
...
$string[ 'cryptex_win'] = 'Вітання!!!!';

//hangman/play.php
$string[ 'hangman_grade'] = 'Оцінка слів';
...
$string[ 'hiddenpicture_grade'] = "Оцінка";
...
$string[ 'hiddenpicture_win'] = "Вітання";
...
$string[ 'millionaire_letters_answers'] = "АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЧШЩЬЮЯ";
...
$string[ 'millionaire_win'] = 'Вітання!!!!';
...
//sudoku/play.php
$string[ 'cross_new'] = 'Нова гра';
$string[ 'sudoku_emptydatabase'] = 'Основа судоку порожня. Виконайте $a для створення';
