<?php  // $Id: play.php,v 1.12.2.6 2010/08/05 07:41:08 bdaloukas Exp $

require( "cross_class.php");
require( "crossdb_class.php");

function game_cross_continue( $id, $game, $attempt, $cross, $g='', $endofgame=false)
{
    if( $endofgame){
		if( $g == ''){
...
function game_cross_play( $id, $game, $attempt, $crossrec, $g, $onlyshow, $showsolution, $endofgame, $print, $checkbutton, $showhtmlsolutions, $showhtmlprintbutton)
{
	...
	$info = $cross->load( $g, $done, $html, $game, $attempt, $crossrec, $onlyshow, $showsolution, $finishattempt, $showhtmlsolutions, $attempt->language);
